...
public class AutoBlueFar extends OpMode {
    ...
    private final Pose scorePose = new Pose(59, 15, Math.toRadians(120));

    private final Pose pickup2Pose = new Pose(44, 38, Math.toRadians(120));

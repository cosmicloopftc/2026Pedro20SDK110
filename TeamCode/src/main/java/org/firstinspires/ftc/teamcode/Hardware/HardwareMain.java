...
//    double driveTheta, r, newRight, newForward;
    ...
    public void init(HardwareMap hardwareMap)    {
        ...
        intakeLeftTransfer.setDirection(DcMotorSimple.Direction.REVERSE); //Change if wrong
        intakeRightTransfer = hardwareMap.get(CRServo.class, "intakeRightTransfer");
        intakeRightTransfer.setDirection(DcMotorSimple.Direction.FORWARD); //Change if wrong

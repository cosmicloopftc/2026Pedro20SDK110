...
public class ConceptDatalogger extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        for (int i = 0; opModeIsActive(); i++)
        {
            ...
            datalog.intakeMotorSpeed.set(robot.intakeMotor.getVelocity());

            // The logged timestamp is taken when writeLine() is called.
            datalog.writeLine();

            // Datalog fields are stored as text only; do not format here.
            telemetry.addData("Motor speed", robot.intakeMotor.getVelocity());
            telemetry.addLine();
    ...
    public static class Datalog
    {
        ...
        public Datalogger.GenericField intakeMotorSpeed          = new Datalogger.GenericField("Intake motor speed");

...
public class AutoRedFar extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(100, 35, Math.toRadians(180)); // Scoring Pose of our robot.
    private final Pose pickup1Pose2 = new Pose(140, 35, Math.toRadians(180));
    private final Pose scorePose = new Pose(93, 15, Math.toRadians(120));

    private final Pose pickup2Pose = new Pose(141, 35, Math.toRadians(270));
    private final Pose pickup2Pose2 = new Pose(141, 11, Math.toRadians(270));
